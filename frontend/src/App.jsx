  ...
  return (
    <div className="card result">
      ...
      <div className="grid2">
        ...
        <Metric label="Personalized ready" value={String(result.personalizedReady)} />
        <Metric label="Training completed" value={String(result.personalizedTrainingCompleted)} />
...
function App() {
  ...
  return <div className="page">
    <header className="hero"><div><h1>CERT R4.2 Multi-view Anomaly Framework</h1><p>Count/statistical view + behavior sequence view + role/group calibration → safe personalized baseline after 30 active days.</p></div><button disabled={loading} onClick={trainGlobal} className="primary"><Database size={18}/> Train Global Role/Group Baseline</button></header>
